...
const (
	// Label holds the string label denoting the userquestionanswer type in the database.
	Label = "user_question_answer"
	...
	UserTable = "user_question_answers"
	...
	QuestionTable = "user_question_answers"
	...
	SelectedOptionTable = "user_question_answers"
...
// OrderOption defines the ordering options for the UserQuestionAnswer queries.
