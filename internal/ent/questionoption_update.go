...
func (qou *QuestionOptionUpdate) SetIsCorrect(b bool) *QuestionOptionUpdate {
	qou.mutation.SetIsCorrect(b)
	return qou
}

// SetNillableIsCorrect sets the "is_correct" field if the given value is not nil.
func (qou *QuestionOptionUpdate) SetNillableIsCorrect(b *bool) *QuestionOptionUpdate {
	if b != nil {
		qou.SetIsCorrect(*b)
	}
	return qou
...
func (qou *QuestionOptionUpdate) AddUserQuestionAnswers(t ...*TestSessionAnswer) *QuestionOptionUpdate {
...
func (qou *QuestionOptionUpdate) RemoveUserQuestionAnswers(t ...*TestSessionAnswer) *QuestionOptionUpdate {
	ids := make([]uuid.UUID, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
func (qou *QuestionOptionUpdate) check() error {
	...
	if qou.mutation.QuestionCleared() && len(qou.mutation.QuestionIDs()) > 0 {
...
func (qou *QuestionOptionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := qou.mutation.IsCorrect(); ok {
		_spec.SetField(questionoption.FieldIsCorrect, field.TypeBool, value)
	}
...
// SetIsCorrect sets the "is_correct" field.
func (qouo *QuestionOptionUpdateOne) SetIsCorrect(b bool) *QuestionOptionUpdateOne {
	qouo.mutation.SetIsCorrect(b)
	return qouo
}

// SetNillableIsCorrect sets the "is_correct" field if the given value is not nil.
func (qouo *QuestionOptionUpdateOne) SetNillableIsCorrect(b *bool) *QuestionOptionUpdateOne {
	if b != nil {
		qouo.SetIsCorrect(*b)
	}
	return qouo
...
// AddUserQuestionAnswers adds the "user_question_answers" edges to the TestSessionAnswer entity.
func (qouo *QuestionOptionUpdateOne) AddUserQuestionAnswers(t ...*TestSessionAnswer) *QuestionOptionUpdateOne {
	ids := make([]uuid.UUID, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// RemoveUserQuestionAnswers removes "user_question_answers" edges to TestSessionAnswer entities.
func (qouo *QuestionOptionUpdateOne) RemoveUserQuestionAnswers(t ...*TestSessionAnswer) *QuestionOptionUpdateOne {
	ids := make([]uuid.UUID, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
func (qouo *QuestionOptionUpdateOne) check() error {
	...
	if qouo.mutation.QuestionCleared() && len(qouo.mutation.QuestionIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "QuestionOption.question"`)
	}
	return nil
}
...
func (qouo *QuestionOptionUpdateOne) sqlSave(ctx context.Context) (_node *QuestionOption, err error) {
	...
	if value, ok := qouo.mutation.IsCorrect(); ok {
		_spec.SetField(questionoption.FieldIsCorrect, field.TypeBool, value)
	}
