...
const (
	// Label holds the string label denoting the testquestionpoint type in the database.
	Label = "test_question_point"
	...
	// Table holds the table name of the testquestionpoint in the database.
	Table = "test_question_points"
	// TestTable is the table that holds the test relation/edge.
	TestTable = "test_question_points"
	...
	QuestionTable = "test_question_points"
...
// Columns holds all SQL columns for testquestionpoint fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the TestQuestionPoint queries.
