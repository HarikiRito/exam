...
const (
	// Label holds the string label denoting the testquestionanswer type in the database.
	Label = "test_question_answer"
	...
	// Table holds the table name of the testquestionanswer in the database.
	Table = "test_question_answers"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "test_question_answers"
	...
	QuestionTable = "test_question_answers"
	...
	SelectedOptionTable = "test_question_answers"
	...
	TestSessionTable = "test_question_answers"
...
// Columns holds all SQL columns for testquestionanswer fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the TestQuestionAnswer queries.
