...
func (qoq *QuestionOptionQuery) First(ctx context.Context) (*QuestionOption, error) {
	nodes, err := qoq.Limit(1).All(setContextOp(ctx, qoq.ctx, ent.OpQueryFirst))
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
...
func (qoq *QuestionOptionQuery) Only(ctx context.Context) (*QuestionOption, error) {
	nodes, err := qoq.Limit(2).All(setContextOp(ctx, qoq.ctx, ent.OpQueryOnly))
	if err != nil {
		return nil, err
	}
	switch len(nodes) {
...
func (qoq *QuestionOptionQuery) All(ctx context.Context) ([]*QuestionOption, error) {
	ctx = setContextOp(ctx, qoq.ctx, ent.OpQueryAll)
	if err := qoq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (qoq *QuestionOptionQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
	...
	ctx = setContextOp(ctx, qoq.ctx, ent.OpQueryIDs)
...
func (qoq *QuestionOptionQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, qoq.ctx, ent.OpQueryCount)
	if err := qoq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (qoq *QuestionOptionQuery) Exist(ctx context.Context) (bool, error) {
	ctx = setContextOp(ctx, qoq.ctx, ent.OpQueryExist)
...
//		GroupBy(questionoption.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.QuestionOption.Query().
//		Select(questionoption.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (qogb *QuestionOptionGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, qogb.build.ctx, ent.OpQueryGroupBy)
...
func (qos *QuestionOptionSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, qos.ctx, ent.OpQuerySelect)
