          ...
          <form className='p-6 md:p-8'>
            <div className='flex flex-col gap-6'>
              ...
              <div className='grid gap-3'>
                ...
                <AppInput id='email' type='email' placeholder='m@example.com' required />
              </div>
              <div className='grid gap-3'>
                ...
                <AppInput id='password' type='password' required />
              </div>
              ...
              <div className='grid grid-cols-3 gap-4'>
                <AppButton variant='outline' type='button' className='w-full'>
