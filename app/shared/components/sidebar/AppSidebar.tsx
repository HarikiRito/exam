...
function Sidebar({
  ...
  if (isMobile) {
    return (
      <AppSheet.Root open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <AppSheet.Header className='sr-only'>
          <AppSheet.Title>Sidebar</AppSheet.Title>
          <AppSheet.Description>Displays the mobile sidebar.</AppSheet.Description>
        </AppSheet.Header>
        <AppSheet.Content
...
function SidebarSeparator({ className, ...props }: React.ComponentProps<typeof AppSeparator>) {
  return (
    <AppSeparator
...
function SidebarMenuButton({
  ...
  readonly tooltip?: string | TooltipContent;
